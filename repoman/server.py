...
def github_reconcile_status(account_names: list[str], root: str | Path | None = None, include_pr_counts: bool = False, force_refresh: bool = False, per_account_budget_seconds: float = 25, global_budget_seconds: float | None = None) -> dict[str, Any]:
    return reconcile_status_for_accounts(account_names, root, include_pr_counts, force_refresh, per_account_budget_seconds, global_budget_seconds)
